    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (player.getWorld().getEnvironment()) {
            ...
            case THE_END:
                ...
                break;
            default:
                dimensionColor = ChatColor.WHITE; // 未知白色
                dimensionInfo = "未知";
                break;
        }

        // 在服务器公屏显示提示信息
        Bukkit.broadcastMessage(ChatColor.AQUA + "[Here] " + ChatColor.YELLOW + player.getName() + ChatColor.WHITE + " 在 " + dimensionColor + dimensionInfo +
                ChatColor.RESET + " 的 [ " +
                ChatColor.RED + x + ChatColor.RESET + " , " +
                ChatColor.GREEN + y + ChatColor.RESET + " , " +
                ChatColor.BLUE + z + ChatColor.RESET + " ]");
